/// Page-level index: maps Mushaf page number (1-604) to its surah segments.
const Map<int, List<Map<String, int>>> pageIndex = {
  1: [
...
const Map<int, List<Map<String, int>>> juzIndex = {
  1: [
    {'surah': 1, 'start': 1, 'end': 7},
  ...
  3: [
    ...
    {'surah': 3, 'start': 1, 'end': 91}
  ],
  4: [
    {'surah': 3, 'start': 92, 'end': 200},
